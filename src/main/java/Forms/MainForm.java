...
public class MainForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem7.setText("Kupoprodajni ugovor");
        ...
        jMenuItem9.setText("Agencija");
        jMenuItem9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem9ActionPerformed(evt);
            }
        });
        itemFormDoznaka.add(jMenuItem9);

        jMenuItem10.setText("Zapisnik");
        jMenuItem10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem10ActionPerformed(evt);
            }
        });
        itemFormDoznaka.add(jMenuItem10);

        jMenuItem11.setText("Rezervacija");
        jMenuItem11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem11ActionPerformed(evt);
            }
        });
        itemFormDoznaka.add(jMenuItem11);
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
       try {
            formUgovorKupoprodaja fu = new formUgovorKupoprodaja();
            fu.setVisible((true));
        } catch (Exception ex) {
    ...
    private void jMenuItem9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
       try {
            formAgencija fa = new formAgencija();
            fa.setVisible((true));
        } catch (Exception ex) {
            Logger.getLogger(formUgovorKupoprodaja.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, "Doslo je do greske: " + ex.getMessage(), "Greska", JOptionPane.ERROR_MESSAGE);
    ...
    private void jMenuItem10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem10ActionPerformed
        try {
            formZapisnik fz = new formZapisnik();
            fz.setVisible((true));
        } catch (Exception ex) {
            Logger.getLogger(formUgovorKupoprodaja.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, "Doslo je do greske: " + ex.getMessage(), "Greska", JOptionPane.ERROR_MESSAGE);
    ...
    private void jMenuItem11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem11ActionPerformed
        try {
            formRezervacija fz = new formRezervacija();
            fz.setVisible((true));
        } catch (Exception ex) {
